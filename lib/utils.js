 ...
 * @returns {string} Parsed Root Registry Key
 */
function parseRootKey (rootKey) {
 ...
 * @returns {string} Parsed Sub Key
 */
function parseSubKey (subKey) {
  if (!subKey) throw new Error('subKey is requried')
...
module.exports = {
  ...
  parseRootKey: parseRootKey,
  parseSubKey: parseSubKey
}
